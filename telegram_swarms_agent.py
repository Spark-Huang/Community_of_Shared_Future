...
async def handle_message(
    ...
    try:
        ...
        # response = jesus_christ_agent.run(cleaned_message + "Respond with a cute girly vibe as if you were a waifu extremely happy  and concerned about the user" + "Respond in the language of the user's request")
